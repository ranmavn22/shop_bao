                    ...
                    if ($(_place).find('.btn-link').length) {
                        $(_place).find('.btn-link').each(function() {
                            if (
                                ...
                                var _span_text=$(this).attr('data-icon-text');

                                if ($(this).hasClass('btn-wishlist') || $(this).hasClass('btn-compare') ) {
                                    var _span_text_2 = $(this).attr('data-added');

                                    $(this).addClass('ns-has-wrap');
                                    ...
                                    if ($(this).hasClass('nasa-added')) {
                                        $(this).find(".nasa-icon-text-wrap").animate({ scrollTop: 24 }, 400 );
                                    }

                                }else {

                                    _span_text = $(this).attr('data-icon-text');
                                    $(this).find('.nasa-icon').after(
