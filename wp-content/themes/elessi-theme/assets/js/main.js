...
jQuery(document).ready(function ($) {
    ...
    $('body').on('added_to_cart', function (ev, fragments, cart_hash, _button) {
         ...
         */
        if (_event_add === 'popup' && $('form.nasa-shopping-cart-form, form.woocommerce-checkout').length <= 0) {
            after_added_to_cart($);
        ...
        if (_event_add === 'popup_2' && $('form.nasa-shopping-cart-form, form.woocommerce-checkout').length <= 0) {
            after_added_to_cart($);
    ...
    $('body').on('change', '.mini-cart-item .qty', function (e) {
        if (
            ...
            var _id_pro = $(_wrap).attr('data-id-product');
            if (!_max) {
                _max = false;
            }
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            if (data && data.fragments) {
                                ...
                                $('body').trigger('get_content_popup_v2');
                            }
    ...
    $('body').on('wc_fragments_refreshed wc_fragments_loaded', function () {
        ...
        if ($('#cart-sidebar .cross-sells').length) {
            crossSellsArray.push($('#cart-sidebar .cross-sells').find('.nasa-slick-slider'));
        }

        if ($('.ns-cart-popup-v2 .cross-sells').length) {
            crossSellsArray.push($('.ns-cart-popup-v2 .cross-sells').find('.nasa-slick-slider'));
        }


        $(crossSellsArray).each(function () {
            if ($(this).length) {

                if ($(this).parents('#cart-sidebar').length) {
                    $(this).attr('data-columns', '3');
                    $(this).attr('data-columns-tablet', '3');
                    $(this).attr('data-columns-small', '3');


                }

                if ($(this).parents('.ns-cart-popup-v2').length) {
                    $(this).attr('data-columns', '4');
                    $(this).attr('data-columns-tablet', '4');
                    $(this).attr('data-columns-small', '4');
                }

                if (!$(this).hasClass('nasa-nav-top')) {
                    $(this).addClass('nasa-nav-top');
                }
                 ...
                 */
                $(this).removeClass('nasa-hoz-buttons');
                $(this).removeClass('nasa-modern-1');
                $(this).removeClass('nasa-modern-2');
                $(this).removeClass('nasa-modern-3');
                $(this).removeClass('nasa-modern-4');
                $(this).removeClass('nasa-modern-5');
                $(this).removeClass('nasa-modern-6');
                $(this).removeClass('nasa-modern-7');
                $(this).removeClass('nasa-modern-8');

                if (!$(this).hasClass('nasa-ver-buttons')) {
                    $(this).addClass('nasa-ver-buttons');
                }
    ...
    $('body').on('get_content_popup_v2',function () {
        if ($('.ns-cart-popup-wrap .ns-cart-popup-v2').length) {
            var _id = $('.ns-cart-popup-wrap .widget_shopping_cart_content').attr('data-id-just-added');
            ...
            $('#cart-sidebar .woocommerce-mini-cart-item').each(function () {
                if ($(this).attr('data-id-product') == _id) {
                    $('.ns-cart-popup-wrap .ns-cart-popup-v2 .nasa-minicart-items .woocommerce-mini-cart').append( $(this).clone());
                }
            });

            if ($('.ns-cart-popup-wrap .woocommerce-mini-cart-item').length <= 0) {
            ...
            var _popup_mini_cart = $('.ns-cart-popup-wrap .ns-cart-popup-v2 .nasa-minicart-items');
            var _max_height = $(_popup_footer).height();

            $(_popup_mini_cart).css({'max-height': _max_height});
