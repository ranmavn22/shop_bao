...
<a href="javascript:void(0);" class="showcoupon-clone ns-add-coupon" data-close="<?php echo esc_html__('Close', 'elessi-theme'); ?>" data-add="<?php echo esc_html__('Add', 'elessi-theme'); ?>" rel="nofollow"><?php echo esc_html__('Add', 'elessi-theme'); ?></a>
