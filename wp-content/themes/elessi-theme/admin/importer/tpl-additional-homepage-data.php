...
if (get_option('nasatheme_imported') === 'imported') : ?>
    <div class="nasa-dashboard-demo-data">
        ...
        <div class="additional-btns">
            ...
            <a class="button button-primary button-hero" href="<?php echo esc_url(admin_url('themes.php?page=optionsframework')); ?>"><?php echo esc_html__('Go to Theme Options', 'elessi-theme'); ?></a>
