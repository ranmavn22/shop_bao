...
if (!function_exists('elessi_get_style_primary_color')) :
    ...
    function elessi_get_style_primary_color($color_primary = '', $return = true) {
        ...
        ?><style>
            ...
            body .topbar-menu-container .header-multi-languages>li:hover>a,
            ...
            html body.nasa-dark .topbar-menu-container .header-multi-languages>li:hover,
            ...
            body .nasa-wrap-review-thumb .nasa-item-review-thumb i:hover
            {
