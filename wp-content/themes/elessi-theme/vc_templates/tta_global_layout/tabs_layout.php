...
if (WPBakeryShortCode_VC_Tta_Section::$section_info) :
    ...
    foreach (WPBakeryShortCode_VC_Tta_Section::$section_info as $k => $v) :
        ...
        $img_icon = '';
        $i_icon = '';
        $before_title = isset($v["before_tab_title"]) && trim($v["before_tab_title"]) !== '' ? '<span class="ns-before_title">'.$v["before_tab_title"].'</span>' : '';
        $after_title = isset($v["after_tab_title"]) && trim($v["after_tab_title"]) !== '' ? '<span class="ns-after_title">'.$v["after_tab_title"].'</span>' : '';
