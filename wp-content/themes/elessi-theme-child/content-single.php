...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
    ...
    <header class="entry-header margin-bottom-25 text-center">
        <?php
            ...
            if (!empty($catName) && !empty($cat_id)) {
                $b[] = '<a href="'. get_category_link($cat_id) .'">'. $catName .'</a>';
            }

            $b[] = '<span>'. get_the_title() .'</span>';
        ?>

        <div class="breadcrumb-docs"><?php echo implode('<i class="pe-7s-angle-right"></i>', $b)?></div>
